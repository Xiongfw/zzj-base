...
export default {
  ...
  IF_Get_Booking_Resource(params, options = {}) {
    return axios.get(baseUrl + 'IF_Get_Booking_Resource', { params, options: { log: false, ...options } })
  },
  /**
   * 22.2、获取科室预约号源
   */
  IF_Get_Booking_Dept_NoSource(params, options = {}) {
    return axios.get(baseUrl + 'IF_Get_Booking_Dept_NoSource', { params, options: { log: false, ...options } })
  },
  /**
   * 22.3、获取医生预约号源 
   */
  IF_Get_Booking_Doc_Resource(params, options = {}) {
    return axios.get(baseUrl + 'IF_Get_Booking_Doc_Resource', { params, options: { log: false, ...options } })
  },
  /**
   * 22.6、确认预约
   */

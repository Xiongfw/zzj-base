...
export default {
  ...
  getOrgList(params, options = {}) {
    return axios.get(baseUrl + 'getOrgList', { params, options })
  },
  /**
   * @param {Object} params 接口入参
   * @param {Object} options 选项
  ...
  getWinCodeList(params, options = {}) {
    return axios.get(baseUrl + 'getWinCodeList', { params, options })
  },
  /**
   * @param {Object} params 接口入参
   * @param {Object} options 选项
  ...
  getOrgWinconfigDetail(params, options = {}) {
    return axios.get(baseUrl + 'getOrgWinconfigDetail', { params, options })
  }
}
...
var BillServiceApi = {
   ...
   * 4.1、检查订单状态（院方）
   */
  IF_Check_Hospital_Trade_Status: function IF_Check_Hospital_Trade_Status(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance({ method: 'get', url: baseUrl$9 + 'IF_Check_Hospital_Trade_Status', params: params, options: options });
  },

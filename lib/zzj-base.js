...
instance.interceptors.request.use(function (config) {
  ...
  if (options.yibao && store.hospital) {
...
var DevYibaoApi = {
  ...
  ReadBaseInfo: function ReadBaseInfo(params) {
    ...
    return instance({ method: 'get', url: baseUrl$p + 'ReadBaseInfo', params: params, options: _extends$1({ yibao: true }, options) });
  },
  ...
  ReadCardNo: function ReadCardNo(params) {
    ...
    return instance({ method: 'get', url: baseUrl$p + 'ReadCardNo', params: params, options: _extends$1({ yibao: true }, options) });
  }
};

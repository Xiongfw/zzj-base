...
var RegistServiceApi = {
  ...
  IF_Get_Regist_Resource: function IF_Get_Regist_Resource(data) {
    ...
    return instance({ method: 'post', url: 'IF_Get_Regist_Resource', data: data, options: _extends$1({ log: false }, options) });
  },
  ...
  IF_Get_Regist_Resource_DataSource: function IF_Get_Regist_Resource_DataSource(data) {
    ...
    return instance({ method: 'post', url: 'IF_Get_Regist_Resource_DataSource', data: data, options: _extends$1({ log: false }, options) });
  },
  ...
  IF_Get_Regist_Doc_Resource: function IF_Get_Regist_Doc_Resource(data) {
    ...
    return instance({ method: 'post', url: 'IF_Get_Regist_Doc_Resource', data: data, options: _extends$1({ log: false }, options) });
  },

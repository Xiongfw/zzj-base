...
var RegistServiceApi = {
  ...
  IF_Get_Regist_Resource: function IF_Get_Regist_Resource(params) {
    ...
    return instance.get(baseUrl$h + 'IF_Get_Regist_Resource', { params: params, options: _extends$1({ log: false }, options) });
  },
  ...
  IF_Get_Regist_Doc_Resource: function IF_Get_Regist_Doc_Resource(params) {
    ...
    return instance.get(baseUrl$h + 'IF_Get_Regist_Doc_Resource', { params: params, options: _extends$1({ log: false }, options) });
  },

  /**
   * 23.3、获取医生挂号号源
   */
  IF_Get_Regist_Doc_Resource_DataSource: function IF_Get_Regist_Doc_Resource_DataSource(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$h + 'IF_Get_Regist_Doc_Resource_DataSource', { params: params, options: _extends$1({ log: false }, options) });
  },

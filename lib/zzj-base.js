...
var RegistServiceApi = {
   ...
   * 23.1、获取挂号资源
   */
  IF_Get_Regist_Resource_DataSource: function IF_Get_Regist_Resource_DataSource(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$h + 'IF_Get_Regist_Resource_DataSource', { params: params, options: _extends$1({ log: false }, options) });
  },

...
var DevPrintApi = {
  ...
  Init: function Init(params) {
    ...
    return instance.get(baseUrl$p + 'Init', { params: params, options: _extends$1({}, defaultOptions, options) });
  },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _context.next = 11;
                return dev.Init({ iPort: config.port, iBaud: config.baud });
...
var __vue_render__$5 = function __vue_render__() {
  ...
  }, [_vm._v("账号配置")]), _vm._v(" "), _vm.nativeMethod ? _c("button", {
    staticClass: "bem-setup__btn bem-setup--shadow",
    on: {
      click: function click($event) {

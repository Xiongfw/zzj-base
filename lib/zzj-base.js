            ...
            switch (_context.prev = _context.next) {
              case 0:
                if (_this.$hospital.log_level) {
                  logs$1 = logs$1.filter(function (log) {
      ...
      CountDown.ticker({
        ...
        callback: function callback() {
          getAllByTime(function (res) {
            ...
            _this2.$hospital.log_level !== 'none' && _this2.lock && Array.isArray(res) && res.length > 0 && _this2.uploadLogs(res);
          }, _this2.time, "h");
        }
      });
    },
...
export { api, audio$1 as audio, instance as axios, install, service as loading, store as localStore, logs as logger, Alert as showalert };

...
var defaultOptions = { log: true, loading: false, alert: false };

var DevPrintApi = {
  /* 打开打印设备串口 */
  OpenDevice: function OpenDevice(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'OpenDevice', { params: params, options: _extends$1({}, defaultOptions, options) });
  },
  ...
  CloseDevice: function CloseDevice(params) {
    ...
    return instance.get(baseUrl$p + 'CloseDevice', { params: params, options: _extends$1({}, defaultOptions, options) });
  },
  ...
  Init: function Init(params) {
    ...
    return instance.post(baseUrl$p + 'Init', params, { options: _extends$1({}, defaultOptions, options) });
  },

  /* 打印字符串 */
  PrintString: function PrintString(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'PrintString', { params: params, options: _extends$1({}, defaultOptions, options) });
  },
  ...
  CutPaper: function CutPaper(params) {
    ...
    return instance.get(baseUrl$p + 'CutPaper', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 切纸 */
  SetLineSpace: function SetLineSpace(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'SetLineSpace', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 获取设备状态 */
  GetDeviceStatus: function GetDeviceStatus(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'GetDeviceStatus', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 设置左边距 */
  SetLeftSpace: function SetLeftSpace(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'SetLeftSpace', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 设置对齐方式 */
  SetAlign: function SetAlign(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'SetAlign', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 设置英文字体 */
  SetPrintFontE: function SetPrintFontE(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'SetPrintFontE', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 微距进纸 */
  Feed: function Feed(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'Feed', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 进纸iLines行 */
  FeedLines: function FeedLines(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'FeedLines', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 打印指定内容条码 */
  PrintBarCode: function PrintBarCode(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'PrintBarCode', { params: params, options: _extends$1({}, defaultOptions, options) });
  },

  /* 打印指定内容二维码 */
  PrintQRCode: function PrintQRCode(params) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return instance.get(baseUrl$p + 'PrintQRCode', { params: params, options: _extends$1({}, defaultOptions, options) });
  }
};

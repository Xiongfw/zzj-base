...
var OrgConfigApi = {
  ...
  getOrgList: function getOrgList(params) {
    ...
    return instance.get(baseUrl + 'getOrgList', { params: params, options: _extends({}, options, { log: false }) });
  },
  ...
  getWinCodeList: function getWinCodeList(params) {
    ...
    return instance.get(baseUrl + 'getWinCodeList', { params: params, options: _extends({}, options, { log: false }) });
  },
  ...
  getOrgWinconfigDetail: function getOrgWinconfigDetail(params) {
    ...
    return instance.get(baseUrl + 'getOrgWinconfigDetail', { params: params, options: _extends({}, options, { log: false }) });
  }
};
